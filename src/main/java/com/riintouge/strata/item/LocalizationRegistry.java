...
public final class LocalizationRegistry implements IResourceManagerReloadListener
{
    public static final LocalizationRegistry INSTANCE = new LocalizationRegistry();
    ...
    private LocalizationRegistry()
    {
        ...
        currentLanguage = minecraft.getLanguageManager().getCurrentLanguage();
