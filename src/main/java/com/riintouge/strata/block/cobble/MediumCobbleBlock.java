...
public class MediumCobbleBlock extends BlockBase implements IMetaPropertyProvider
{
    public static final MediumCobbleBlock INSTANCE = new MediumCobbleBlock();
    public static final String RegistryName = "strata:medium_cobble";
    public static final String UnlocalizedName = "strata:medium_cobble";

    public MediumCobbleBlock()
    {
        super( Material.ROCK );
