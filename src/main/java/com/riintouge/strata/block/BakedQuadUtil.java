...
// This code is heavily modified from TheGreyGhosts's wonderful Git repo here:
...
public class BakedQuadUtil
{
    ...
    private static int[] sideToVertexData( Vector3f[] vec , TextureAtlasSprite texture )
    {
        ...
        return Ints.concat(
            ...
            vertexToInts( vec[ 1 ] , Color.WHITE.getRGB() , texture , 0 , 16 , packedNormal ),
            vertexToInts( vec[ 2 ] , Color.WHITE.getRGB() , texture , 16 , 16 , packedNormal ),
            vertexToInts( vec[ 3 ] , Color.WHITE.getRGB() , texture , 16 , 0, packedNormal ) );
    }
