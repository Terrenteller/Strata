...
public enum TileType
{
    ...
    COBBLESLABS         ( false , "%s:%s_cobbleslabs"         , Material.ROCK     , SoundType.STONE , "pickaxe" , COBBLESLAB      , "proto_slab"           , "half=bottom,variant=default"            ),
    STONESLAB           ( false , "%s:%s_stoneslab"           , Material.ROCK     , SoundType.STONE , "pickaxe" , STONE           , "proto_slab"           , "half=bottom,variant=default"            ),
    STONESLABS          ( false , "%s:%s_stoneslabs"          , Material.ROCK     , SoundType.STONE , "pickaxe" , STONESLAB       , "proto_slab"           , "half=bottom,variant=default"            ),
    ...
    STONEBRICKSLABS     ( false , "%s:%s_stonebrickslabs"     , Material.ROCK     , SoundType.STONE , "pickaxe" , STONEBRICKSLAB  , "proto_slab"           , "half=bottom,variant=default"            ),
